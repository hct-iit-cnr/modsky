  ...
  // --- MODSKY INTERVENTION LOGIC START ---
    ...
    useEffect(() => {
      ...
      const loadingTimer = setTimeout(() => {
        ...
        // --- FIXED: Dynamically pulls the reading duration correctly ---
    ...
    const renderIntervention = (targetPosition: InterventionPosition) => {
      ...
      return (
        <Animated.View 
          entering={FadeIn} 
          style={[
            a.w_full, a.px_lg, a.py_md, 
            isHiddenPhase ? { backgroundColor: 'transparent' } : t.atoms.bg_contrast_25,
            isTitle ? a.mt_md : {},
            { borderRadius: 12, marginHorizontal: 16, width: 'auto', marginBottom: 16 }
          ]}>
          <View style={[
            ...
            {interventionState.hasIcon && (
              <CircleInfoIcon size="md" />
            )}
            <Text style={[a.flex_1, a.text_md, a.font_bold, t.atoms.text, isTitle ? { textAlign: 'center' } : {}]}>
